...
**This repository is now legacy and in maintenance mode for ROS1 support. For the latest development releases (standalone or ROS2), shift your xeyes to https://github.com/kobuki-base/kobuki_core.git.**
